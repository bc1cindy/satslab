-- ===============================================
-- SatsLab Analytics System - Complete Setup
-- ===============================================
-- IMPORTANTE: Execute PRIMEIRO o script supabase_base_tables.sql
-- Depois execute este script no SQL Editor do Supabase Dashboard

-- 1. Criar tabela de sessões de usuário
...
-- 2. Criar tabela de eventos de usuário
...
-- 3. Criar tabela de analytics agregados
...
-- 11. Criar função para configurar user context (usar no código)
...
-- 12. Criar view para estatísticas por módulo
...
-- 13. Criar função para obter estatísticas gerais
...
-- 3. No código, sempre chame set_current_user_id(user_id) antes de queries
-- 4. Use as views e funções para relatórios e analytics
-- 
-- Exemplo de uso no código:
-- SELECT set_current_user_id('user_public_key');
-- SELECT * FROM user_analytics_summary WHERE user_id = 'user_public_key';
-- 
