...
export const config = {
  matcher: [
    /*
     * SEGURANÇA: Aplicar middleware a TODAS as rotas, incluindo APIs Pro
     * Excluir apenas recursos estáticos e APIs públicas específicas
     */
    '/((?!_next/static|_next/image|favicon.ico|api/auth/callback|api/webhooks).*)',
  ],
}